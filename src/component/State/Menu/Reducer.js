...
const menuItemReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.GET_MENU_ITEM_BY_RESTAURANTS_ID_REQUEST:
        ...
        case actionTypes.GET_MENU_ITEM_BY_RESTAURANTS_ID_SUCCESS:
            return {
                ...state,
                loading: false,
        ...
        case actionTypes.GET_MENU_ITEM_BY_RESTAURANTS_ID_FAILURE:
